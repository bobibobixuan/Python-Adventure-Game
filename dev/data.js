...
// 成就配置
        const achievementList = [
            { id: 'first_win', name: '初试锋芒', icon: '🌱', desc: '首次答对题目', condition: (stats) => stats.totalCorrect >= 1 },
            { id: 'speed_demon', name: '速算达人', icon: '⚡', desc: '5秒内答对一道题', condition: (stats) => stats.fastAnswer },
            { id: 'combo_master', name: '连击大师', icon: '🔥', desc: '连续答对5题', condition: (stats) => stats.maxCombo >= 5 },
            { id: 'perfect_clear', name: '满分通关', icon: '💎', desc: '一关不扣血通关', condition: (stats) => stats.perfectLevel },
            { id: 'master_of_operators', name: '闯关大师', icon: '👑', desc: '通关全部关卡', condition: (stats) => stats.allLevelsClear },
            { id: 'survivor', name: '九死一生', icon: '🌟', desc: '只剩1条命通关', condition: (stats) => stats.oneLifeWin },
            { id: 'scholar', name: '勤学苦练', icon: '📚', desc: '在修炼场完成10道题', condition: (stats) => stats.practiceCount >= 10 },
            { id: 'speed_5', name: '快如闪电', icon: '💨', desc: '连续5题都在5秒内答对', condition: (stats) => stats.fastStreak >= 5 },
            { id: 'no_mistake', name: '零失误', icon: '🎯', desc: '一整关答对所有题', condition: (stats) => stats.perfectStreak },
            { id: 'practice_veteran', name: '修炼老将', icon: '🧘', desc: '在修炼场完成30道题', condition: (stats) => stats.practiceCount >= 30 },
            { id: 'question_hunter', name: '百题斩', icon: '🗡️', desc: '累计完成100道题', condition: (stats) => stats.totalQuestions >= 100 },
            { id: 'star_collector', name: '星光收藏家', icon: '🌠', desc: '累计获得12颗星星', condition: (stats) => stats.totalStars >= 12 },
            { id: 'dual_unit_clear', name: '双线通关', icon: '🧭', desc: '完成全部两个单元', condition: (stats) => stats.completedUnits >= stats.totalUnits },
            { id: 'extreme_conqueror', name: '零失误通关', icon: '👑', desc: '通过一次双单元综合大考', condition: (stats) => stats.extremeDualPasses >= 1 }
        ];
